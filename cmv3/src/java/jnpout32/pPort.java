...
/**
 *Paralell port access.
 *Derived from the web by Dr Kenneth Schweller,
...
public class pPort {
    ...
    /**
     * Hex Address of Data Byte of PC Parallel Port and initialize port bits to 0.
    @author Dr. Kenneth G. Schweller
     **/
    public pPort() {
        pp = new ioPort();
    ...
    public void setAllDataBits(short value) {
      ...
      /**
     * For users who prefer dealing with Pin numbers ans set Pin <pin> to <value>
    @author Dr. Kenneth G. Schweller
     **/

    public void setPin(short pin, short value) {
        if (pin >= 2 && pin <= 9) // just set the corresponding Data bit to indicted value
        {
